...
if __name__ == '__main__':
    # TrenNet128_1c_{datetime.now().strftime("%Y_%m%d_%H%M")}
    configuration = {
        'case_name': f'PSPNet_1c_{datetime.now().strftime("%Y_%m%d_%H%M")}',
        ...
        'note': 'split[0.7,0.1,0.2], data_modified, adamw, BCEwithlogitsloss, seed=0',
    }
